  ...
  render() {
    return (
      <ul className={"ul_nav_bar"}>
        ...
        <li className={"navBarLinkListItem"}>
          <a href={"https://drive.google.com/file/d/1RA6__860h1ZrlnGR800aZHu4AG6d7shM/view?usp=sharing"} rel={"noopener noreferrer"} title={"Raj's resume"} target={"_blank"}>Resume</a>
        </li>
